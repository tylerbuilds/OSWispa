...
3. Keep its console window open while dictating.
4. Hold Ctrl+Windows, speak, then release the keys.

Windows may ask for microphone access on first use. If recording does not
